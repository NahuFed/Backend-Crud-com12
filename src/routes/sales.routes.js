...
router.route('/sales')
    .get(obtenerVentas) // Solo admin puede ver todas las ventas
    .post(crearVenta); // Cualquier usuario autenticado puede crear una venta
router.route('/sales/:id')
    .get(obtenerUnaVenta); // Cualquier usuario autenticado puede ver una venta por ID
